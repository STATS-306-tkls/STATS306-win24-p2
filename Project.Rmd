...
runtime_year <- title_basics |>
  group_by(startYear) |>
  summarize(mean_rt = mean(runtimeMinutes),
            med_rt = median(runtimeMinutes), 
            min_rt = min(runtimeMinutes), 
            max_rt = max(runtimeMinutes))
runtime_year
...
#WHAT IS RED ON GRAPH - MISSING LABEL (DRAMA?)
```
