...
#title_basics %>% count(originalTitle)  # Replace `column_name` with actual column names
#ggplot(title_basics) +
...
deathAge <- 2024 - name_basics$deathYear
...
max_cor_val <- max(abs(correlations[lower.tri(correlations)]))
...
* Join the names_basics with the ratings and the principals table. - based on tconst and nconst
  ...
  * Graph ratings against years. What trends do you see? - group by people, 
